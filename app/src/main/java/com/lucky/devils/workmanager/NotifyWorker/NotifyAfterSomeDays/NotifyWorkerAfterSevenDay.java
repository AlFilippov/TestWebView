...
public class NotifyWorkerAfterSevenDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterSevenDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.seven_after_title, R.string.seven_after_text));
