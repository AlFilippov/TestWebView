...
public class NotifyWorkerAfterSevenTeenDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterSevenTeenDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.seventeen_after_title, R.string.seventeen_after_text));
