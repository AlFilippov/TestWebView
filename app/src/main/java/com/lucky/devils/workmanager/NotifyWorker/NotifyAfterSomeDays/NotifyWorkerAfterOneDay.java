...
public class NotifyWorkerAfterOneDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterOneDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.one_after_title, R.string.one_after_text));
