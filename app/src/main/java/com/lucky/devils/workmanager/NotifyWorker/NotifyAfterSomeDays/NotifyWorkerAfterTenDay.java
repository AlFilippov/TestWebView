...
public class NotifyWorkerAfterTenDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterTenDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.ten_after_title, R.string.ten_after_text));
