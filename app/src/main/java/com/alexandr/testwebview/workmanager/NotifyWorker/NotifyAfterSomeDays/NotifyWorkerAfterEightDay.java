...
public class NotifyWorkerAfterEightDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterEightDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.eight_after_title, R.string.eight_after_text));
