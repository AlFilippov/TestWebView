...
public class NotifyWorkerAfterTwentySevenDay extends Worker {
    ...
    public NotifyWorkerAfterTwentySevenDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.twentyseven_after_title, R.string.twentyseven_after_text));
