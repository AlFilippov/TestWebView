...
public class NotifyWorkerAfterThreeDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterThreeDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.three_after_title, R.string.three_after_text));
