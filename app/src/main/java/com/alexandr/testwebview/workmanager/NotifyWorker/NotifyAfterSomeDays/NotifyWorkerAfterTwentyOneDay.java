...
public class NotifyWorkerAfterTwentyOneDay extends Worker {
    private NotificationCreator mCreator;

    public NotifyWorkerAfterTwentyOneDay(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    private void sendNotification() {
        ...
        Objects.requireNonNull(notificationManager).notify(1, mCreator.notifyCreate(createIntent(),
                getApplicationContext(), R.string.twenty_after_title, R.string.twenty_after_text));
