package com.alexandr.testwebview.widget;
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.FButton_shadowEnabled) {
                ...
                mShadowHeight = typedArray.getDimensionPixelSize(attr, getResources().getDimensionPixelOffset(R.dimen.fbutton_default_shadow_height));
            } else if (attr == R.styleable.FButton_cornerRadius) {
                mCornerRadius = typedArray.getDimensionPixelSize(attr, getResources().getDimensionPixelOffset(R.dimen.fbutton_default_conner_radius));
            }
        }
        typedArray.recycle();
